...
# Create a function to check whether a number is positive or negative.
# def check_Pos_neg(a):
#     if a > 0:
#         return "Positive"
#     elif a < 0:
...
#     else:
#         return "Enter a corrected number"
# result=largest(0, 1)
# print(result)
